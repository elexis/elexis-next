...
public class BezugsKontaktAuswahl extends Dialog {
	...
	public void create(){
		super.create();
		getShell().setText(ch.elexis.views.Messages.getString("Patientenblatt2.kindOfRelation")); //$NON-NLS-1$
	}
	...
	protected Control createDialogArea(Composite parent){
		...
		String bez = Hub.globalCfg.get(Patientenblatt2.CFG_BEZUGSKONTAKTTYPEN, ""); //$NON-NLS-1$
