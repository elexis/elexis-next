 ...
 * 
 *******************************************************************************/
package ch.elexis.core.ui.provider;
 ...
 * 
 */
public class RnContentProvider implements ViewerConfigurer.ICommonViewerContentProvider,
	...
	public RnContentProvider(final RechnungsListeView l, final CommonViewer cv){
		this.cv = cv;
		rlv = l;
	}
