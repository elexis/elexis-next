...
public class KontaktDetailDialog extends TitleAreaDialog {
	...
	private static final String LBL_BIRTHDATE = Messages
		.getString("KontaktDetailDialog.labelBirthdate"); //$NON-NLS-1$
	private static final String LBL_FIRSTNAME = Messages
		.getString("KontaktDetailDialog.labelFirstname"); //$NON-NLS-1$
