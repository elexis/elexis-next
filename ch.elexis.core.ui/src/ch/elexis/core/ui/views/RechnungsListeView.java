...
import ch.elexis.core.ui.actions.RnActions;
import ch.elexis.core.ui.controls.MoneyInput;
import ch.elexis.core.ui.controls.NumberInput;
import ch.elexis.core.ui.listener.RnMenuListener;
import ch.elexis.core.ui.misc.SWTHelper;
import ch.elexis.core.ui.provider.RnContentProvider;
...
public class RechnungsListeView extends ViewPart implements ElexisEventListener {
	...
	public ViewerConfigurer vc;
	public RnActions actions;
	public RnContentProvider cntp;
	public RnControlFieldProvider cfp;
	
	public Text tPat, tRn, tSum, tOpen;
	NumberInput niDaysTo1st, niDaysTo2nd, niDaysTo3rd;
	MoneyInput mi1st, mi2nd, mi3rd;
	SelectionListener mahnWizardListener;
	FormToolkit tk = Activator.getToolkit();
