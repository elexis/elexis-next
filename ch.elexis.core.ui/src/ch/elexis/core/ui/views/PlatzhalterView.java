...
import ch.elexis.util.IDataAccess.Element;
import ch.elexis.util.SortedList;
import ch.elexis.views.textsystem.Messages;
import ch.elexis.views.textsystem.PlatzhalterProperties;
import ch.elexis.views.textsystem.PlatzhalterTreeData;
