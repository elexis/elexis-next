...
import ch.elexis.core.ui.dialogs.RnDialogs;
import ch.elexis.core.ui.dialogs.RnFilterDialog;
import ch.elexis.core.ui.dialogs.RnOutputDialog;
import ch.elexis.core.ui.misc.SWTHelper;
import ch.elexis.core.ui.provider.RnControlFieldProvider;
...
public class RnActions {
	public Action rnExportAction, editCaseAction, delRnAction, reactivateRnAction, patDetailAction;
	public Action expandAllAction, collapseAllAction, reloadAction;
	public Action mahnWizardAction;
	public Action addPaymentAction, addExpenseAction, changeStatusAction, stornoAction;
	public Action increaseLevelAction, printListeAction, rnFilterAction;
	public Action addAccountExcessAction;
	
	public RnActions(final RechnungsListeView view){
